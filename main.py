...
st.write('**Nota**: *La utilidad bruta* de una empresa es la ganancia que se obtiene de la venta de un producto luego de restarle los costos asociados a su producción. Por otra parte, a fin de determinar la *utilidad neta* es necesario considerar otros costos fijos, operativos y de inversión.')st.markdown('**Agradecimientos por suministrar información y orientación: Shirley Perez (AGROSAVIA), Angela Vasquez (AGROSAVIA), Juan Carlos Martinez (Agrosavia), Alberto Garcia (CLAYUCA), Bernardo Ospina (CLAYUCA)**')
