...
if Menubar == 'Producción de raíces frescas de yuca':
	...
	Alq = st.number_input('Alquiler de una (1) hectárea "civilizada" o "sin civilizar" (en miles de pesos $)',900000.00, format='$%f')
	...
	st.error(f"**Costos totales por hectárea: ${round(Tot,1)}**")
